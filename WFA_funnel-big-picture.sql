...
(
SELECT event_name,
       COUNTIF(top_countries.country_rank = 1) AS country_1,
       COUNTIF(top_countries.country_rank = 2) AS country_2,
       COUNTIF(top_countries.country_rank = 3) AS country_3,
       COUNTIF(top_countries.country_rank IN (1, 2, 3)) AS country_podium,
       COUNT(*) AS all_countries,
