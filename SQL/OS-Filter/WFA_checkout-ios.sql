...
(
SELECT event_name,
       COUNTIF(top_countries.country_rank = 1 AND operating_system = 'iOS') AS country_1,
       COUNTIF(top_countries.country_rank = 2 AND operating_system = 'iOS') AS country_2,
       COUNTIF(top_countries.country_rank = 3 AND operating_system = 'iOS') AS country_3,
       COUNTIF(top_countries.country_rank IN (1, 2, 3) AND operating_system = 'iOS') AS country_podium,
       COUNTIF(operating_system = 'iOS') AS all_countries,
